...
import { resolveAppRoute, resolveAuthorizedRoute } from "./routing/appRoute";
...
export function AppRouter(){const requestedRoute=resolveAppRoute(window.location.pathname);const auth=useAuth();const[,rerender]=useState(0);if(auth.loading)return <main className="system-loading">Preparando o acesso seguro…</main>;
