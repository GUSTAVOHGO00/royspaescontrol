...
export function AccessManagement() {
  ...
  function resetPassword(profileId: string) {
    const next = window.prompt("Digite a nova senha da loja (mínimo de 4 caracteres):");
    if (!next) return;
    if (next.length < 4) { setMessage("A nova senha precisa ter pelo menos 4 caracteres."); return; }
